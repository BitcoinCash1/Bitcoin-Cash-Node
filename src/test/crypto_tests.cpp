...
BOOST_AUTO_TEST_CASE(muhash_tests) {
    ...
    for (int iter = 0; iter < 10; ++iter) {
        ...
        MuHash3072 x = FromInt(InsecureRandBits(4)); // x=X
        MuHash3072 y = FromInt(InsecureRandBits(4)); // x=X, y=Y
    ...
    auto data = ParseHex("");
    VectorReader ss_max{0, 0, data, 0};
