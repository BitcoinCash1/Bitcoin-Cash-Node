...
from test_framework.cdefs import DEFAULT_CONSENSUS_BLOCK_SIZE
...
class ChainstateWriteCrashTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.node3_args = [
            "-blockmaxsize={}".format(DEFAULT_CONSENSUS_BLOCK_SIZE), "-acceptnonstdtxn"]
    ...
    def restart_node(self, node_index, expected_tip):
        ...
        while time.time() - time_start < 120:
            try:
                ...
                utxo_hash = self.nodes[node_index].gettxoutsetinfo('ecmh')[
                    'ecmh']
                return utxo_hash
            except Exception:
    ...
    def sync_node3blocks(self, block_hashes):
        ...
        node3_utxo_hash = self.nodes[3].gettxoutsetinfo('ecmh')['ecmh']
    ...
    def verify_utxo_hash(self):
        ...
        for i in range(3):
            try:
                nodei_utxo_hash = self.nodes[i].gettxoutsetinfo('ecmh')[
                    'ecmh']
            except OSError:
